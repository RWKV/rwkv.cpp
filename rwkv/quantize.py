# Quantizes rwkv.cpp model file from FP32 or FP16 to Q4_0, Q4_1, Q4_1_O, Q4_2.
...
def parse_args():
    parser = argparse.ArgumentParser(description='Quantize rwkv.cpp model file from FP32 or FP16 to Q4_0, Q4_1, Q4_1_O, Q4_2')
    ...
    parser.add_argument('data_type', help='Data type, '
                                          ...
                                          '3 (GGML_TYPE_Q4_1), '
                                          '4 (GGML_TYPE_Q4_1_O), '
                                          '5 (Q4_2)', type=int, choices=[2, 3, 4, 5, 6], default=4)
